    ...
    <ul class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 my-2">
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/tum-bbm">TUM BBM</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-elektronik-kelas">Timbangan Elektronik Kelas</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-jembatan">Timbangan Jembatan</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-pegas">Timbangan Pegas</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-meja">Timbangan Meja</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-bobot-ingsut">Timbangan Bobot Ingsut</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/timbangan-sentisimal">Timbangan Sensitisimal</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/pompa-ukur-bbm">Pompa Ukur BBM</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/dacin">Dacin</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/neraca">Neraca</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/takaran-basah-kering">Takaran Basah Kering</a>
      </li>
      <li>
        <a class="block text-center bg-light py-1 rounded-md text-primary font-semibold hover:opacity-80"
          href="/layanan/meter-kayu">Meter Kayu</a>
      </li>
    </ul>
  </section>
