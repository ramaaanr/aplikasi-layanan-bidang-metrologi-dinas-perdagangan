...
<section class="guest__page w-full flex flex-row">
  ...
  <div class="container__hero bg-[url('{{ asset('/images/hero.jpeg') }}')] w-1/2 h-screen">
    <div
      class="opacity__layer bg-opacity-70 bg-primary w-full h-full flex flex-wrap flex-col justify-center content-center pb-8 gap-y-1">
