    ...
    <div class="relative p-4  w-full max-w-md max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-4 md:p-5 text-center">
          ...
          <a href="/pengelolaan-layanan/data-kendaraan"
    ...
    <form wire:submit.prevent="submit" class="form-kendaraan md:grid md:grid-cols-2 md:gap-x-4 lg:gap-x-8">
      <div class="order-1 form-group-container my-2">
        ...
        <div class="relative mt-3">
          <input wire:model.live="merek_kendaraan" name="nama_kendaraan" type="text" id="nama_kendaraan"
        ...
        <div class="relative mt-3">
          <input wire:model.live='nomor_polisi' name="nomor_polisi" type="text" id="nomor_polisi"
            class="form-input peer" placeholder=" "></input>
        ...
        <div class="relative mt-3">
          <input wire:model.live='nomor_rangka' name="nomor_rangka" type="text" id="nomor_rangka"
            class="form-input peer" placeholder=" "></input>
      ...
      <div class="order-2 form-group-container my-2">
        ...
        <div class="relative mt-3">
          <select wire:model.live="perusahaan_id" id="perusahaan"
      ...
      <div class="order-3 form-group-container my-2">
        ...
        <div class="relative mt-3">
          <input wire:model.live="pemilik_stnk" name="pemilik_stnk" type="text" id="pemilik_stnk"
            class="form-input peer " placeholder=" " />
        ...
        <div class="relative mt-3">
          <input wire:model.live="alamat_stnk" name="alamat_stnk" type="text" id="alamat_stnk" class="form-input peer "
            placeholder=" " />
      ...
      <div class="order-4 form-group-container my-2">
        ...
        <div class="form-group-container my-2">
          <div class="relative mt-3">
            <select wire:model.live="volume" id="volume"
              class="input-sm pt-4 pl-4 bg-white text-sm text-left inline-flex justify-between text-dark-grey">
          ...
          @enderror
          <div class="relative mt-3">
            <select wire:model.live="kompartemen" id="kompartemen"
              class="input-sm pt-4 pl-4 bg-white text-sm text-left inline-flex justify-between text-dark-grey">
