<div class="card-sm p-4 min-h-[74vh] flex flex-col justify-start">
  ...
  <div class="action-container grid grid-cols-3 md:grid-cols-4 gap-x-2" x-data="{ selectValue: 'Berdasarkan' }">
    ...
    <select wire:model.live="perusahaan" id="perusahaan" class="input-sm bg-white text-sm text-left inline-flex justify-between text-dark-grey">
    ...
    <!-- ➕ Pengajuan Start -->
    <a href="/pengelolaan-layanan/ajukan-kendaraan/" class="button-primary-sm w-full h-fit flex justify-center col-span-3 md:col-auto">
      <svg class="w-[18px] h-[18px] fill-light mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
