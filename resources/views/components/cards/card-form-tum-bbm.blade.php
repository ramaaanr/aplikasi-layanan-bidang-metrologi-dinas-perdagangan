<div class="card-sm p-4  min-h-[74vh]">
  ...
  <form wire:submit.prevent='submit' class="md:grid md:grid-cols-2 md:gap-x-4 lg:gap-x-8">
    ...
    <div class="order-3 form-group-container my-2">
      ...
      @enderror
      <div class="relative mt-3">
        <input wire:model.live='form.kota_skhp' name="kota_skhp" type="text" id="kota_skhp" class="form-input peer "
          placeholder=" " />
        <label for="kota_skhp"
      ...
      @enderror
      <div class="relative mt-3">
        <input wire:model.live='form.provinsi_skhp' name="provinsi_skhp" type="text" id="provinsi_skhp"
          class="form-input peer " placeholder=" " />
    ...
    <div class="order-4 form-group-container my-2">
      ...
      <div class="relative mt-3">
        <input wire:model.live='form.merek_kendaraan' name="merek_kendaraan" type="text" id="merek_kendaraan"
          class="form-input peer" placeholder=" " />
        <label for="merek_kendaraan"
          class="absolute text-sm text-dark-grey duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Merek
          Kendaraan
        </label>
      </div>
      ...
      @enderror
      <div class="relative mt-3">
        <input wire:model.live='form.nomor_polisi' name="nomor_polisi" type="text" id="nomor_polisi"
          class="form-input peer" placeholder=" " />
      ...
      <div class="relative mt-3">
        <input wire:model.live='form.nomor_rangka' name="nomor_rangka" type="text" id="nomor_rangka"
          class="form-input peer" placeholder=" " />
      ...
      @enderror
      <div class="relative mt-3">
        <input wire:model.live='form.pemilik_stnk' name="pemilik_stnk" type="text" id="pemilik_stnk"
          class="form-input peer" placeholder=" " />
        <label for="pemilik_stnk"
          class="absolute text-sm text-dark-grey duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Pemilik
      ...
      @enderror
      <div class="relative mt-3">
        <input wire:model.live='form.alamat_stnk' name="alamat_stnk" type="text" id="alamat_stnk"
          class="form-input peer " placeholder=" " />
        <label for="alamat_stnk"
          class="absolute text-sm text-dark-grey duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Alamat
    ...
    <div class="order-5 form-group-container my-2">
      ...
      <p class="text-xs text-grey">Isi Tanggal Cek Fisik terlebih dahulu</p>
      <div class="form-group-container my-2">
        <div class="relative mt-3">
          @if ($tanggalCekFisik == null)
        ...
        @enderror
        <div class="relative mt-3">
          <select wire:model.live="form.kompartemen" id="kompartemen"
            class="input-sm pt-4 pl-4 bg-white text-sm text-left inline-flex justify-between text-dark-grey">
            <option value="1">1 (Satu)</option>
            <option value="2">2 (Dua)</option>
          </select>
          <label for="kompartemen"
            class="absolute text-sm text-dark-grey duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-primary peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">
            Kompartemen</label>
        </div>
      ...
      <div class="form-group-container mt-6 mb-2">
        ...
        <div class="flex items-center mb-2 pl-2">
          <input wire:model.live="form.lemping_volume_nominal" id="lemping_volume_nominal" type="checkbox" value=""
        ...
        <div class="flex items-center mb-2 pl-2">
          <input wire:model.live="form.indeks_tera" id="indeks_tera" type="checkbox" value=""
            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
          <label for="indeks_tera" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Apakah
            Indeks Tera Ada?</label>
        </div>
        <div class="flex items-center mb-2 pl-2">
          <input wire:model.live="form.lemping_merk_tum_bbm" id="lemping_merk_tum_bbm" type="checkbox" value=""
            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="order-6 form-group-container my-2">
      ...
      <div class="mt-3 " x-data="{ showReupload: false }">
        ...
        <div x-show="showReupload" class="after-reupload">
          ...
          <input accept=".pdf" wire:model.live='form.file_dokumen_stnk' name="dokumen_stnk"
            class="block w-full text-sm text-dark-grey border-2 border-grey rounded-lg cursor-pointer bg-light  focus:outline-none "
            aria-describedby="file_input_help" placeholder="ikan" id="dokumen_stnk" type="file">
    ...
    <div class="order-9 form-group-container my-2">
      <p class="text-sm md:text-base font-semibold">Tanggal Cek Fisik</p>
