<div class="card-sm p-4  min-h-[74vh]">
  ...
  <form class="md:grid  md:grid-cols-2 md:gap-x-4 lg:gap-x-8" action="">
    ...
    <div class="order-3 form-group-container">
      ...
      <div class="relative my-3">
        <input type="text" id="skhp-kota" class="form-input peer font-medium" placeholder=" " value="Banjarbaru"
          readonly />
        <label for="skhp-kota"
    ...
    <div class="order-4 form-group-container">
      ...
      <div class="my-3">
        ...
        <input
          ...
          aria-describedby="file_input_help" placeholder="ikan" id="file_input_1" type="file">
      ...
      <div class="my-3">
        ...
        <input
          class="block w-full text-sm text-dark-grey border-2 border-grey rounded-lg cursor-pointer bg-light  focus:outline-none "
          aria-describedby="file_input_help" placeholder="ikan" id="file_input_2" type="file">
        <p class="mt-1 text-sm text-grey" id="file_input_help">PDF, PNG, JPG (Max 5MB)</p>
      </div>
      <div class="my-3">
        ...
        <input
          class="block w-full text-sm text-dark-grey border-2 border-grey rounded-lg cursor-pointer bg-light  focus:outline-none "
          aria-describedby="file_input_help" placeholder="ikan" id="file_input_3" type="file" multiple>
        <p class="mt-1 text-sm text-grey" id="file_input_help">PDF, PNG, JPG (Max 5MB)</p>
      </div>
    </div>
    ...
    <div class="order-5 form-group-container">
      ...
      <div class="relative w-full my-3">
        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
          <svg class="w-4 h-4 text-grey" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
            viewBox="0 0 20 20">
            <path
              d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z" />
          </svg>
        </div>
        <input datepicker datepicker-autohide type="text" placeholder="Tanggal Pengujian"
          class="shadow-md bg-light border-2 border-grey text-dark-grey text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-2.5 ">
      </div>
    </div>

    <!-- ➕ Pengajuan Start -->
    <button id="ajukan-tera" type="submit" href="/layanan/ajukan-tera/{{$tera}}" x-on:click.prevent=""
      class="order-7 md:col-span-2 button-primary w-full mt-8 h-fit flex justify-center col-span-2 ">
    ...
    <script type="module">
    document.getElementById('ajukan-tera').onclick = () => {
      Swal.fire({
        icon: 'success',
        title: 'Kode Pengajuan anda: <b>ASDASDASD</b>',
