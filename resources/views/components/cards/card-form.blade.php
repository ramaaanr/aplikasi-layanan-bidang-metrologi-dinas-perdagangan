  ...
  <form wire:submit.prevent='submit' class="md:grid md:grid-cols-2 md:gap-x-4 lg:gap-x-8">
    ...
    <div class="order-first md:col-span-2 form-group-container my-2">
      ...
      <div class="flex gap-x-6">
        ...
        <div class="w-full relative mt-3">
          ...
          <input wire:model.live='form.keterangan' id="keterangan" rows="4" class="block p-2.5 pt-4 pl-3 w-full text-sm text-dark-grey bg-light rounded-lg border border-dark-grey focus:ring-primary focus:border-primary " placeholder="Keterangan"></input>
    ...
    <div class="order-5 pr-4 form-group-container">
      ...
      <div class="relative my-3">
        @if ($isOnUpdate)
        <input disabled min="1" wire:model.live="form.jumlah_uttp" type="number" id="jumlah-uttp" class="form-input peer" placeholder=" " />
        @else
    ...
    <div class="order-10 form-group-container my-2" x-data="{ tempat_pengujian: '{{$form->tempat_pengujian}}' }">
      ...
      <select x-bind:disabled="{{$tera == 'timbangan-jembatan'}}" wire:model.live='form.tempat_pengujian' name="tempat_pengujian" x-model="tempat_pengujian" class="input-sm mt-3 bg-white text-sm text-left inline-flex justify-between text-grey">
