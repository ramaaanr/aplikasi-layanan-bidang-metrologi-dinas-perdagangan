    ...
    <div class="relative bg-light rounded-lg shadow ">
      ...
      <div class="p-6 space-y-6">
        <h3 class="text-3xl  text-grey">
          Kode Pengajuan: <strong>{{$kode_pengajuan}}</strong>
        </h3>
        <p class="text-base  text-gray-500">
          Simpan kode pengajuan untuk diserahkan ke petugas. Tunggu dan pantau status pengajuan anda dalam
          halaman data tera sebelum pengujian tera anda dijadwalkan.
        </p>
      </div>
      <!-- Modal footer -->
