<div class="point-content w-full">
  ...
  <div class="table w-full">
    <div class="thead w-full flex">
      ...
      <div class="border w-full py-2 pl-1 th border-black font-normal text-black text-sm">Jenis</div>
    </div>
    <div class="tbody">
      ...
      <div class="tr flex">
        ...
        <div class="border w-full th py-2 pl-1 border-black font-normal text-black text-sm">{{$data->jenis}}</div>
      </div>
      @endforeach
