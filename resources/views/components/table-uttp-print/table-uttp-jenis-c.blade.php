<div class="point-content w-full">
  ...
  <div class="table w-full">
    <div class="thead w-full flex">
      ...
      <div class="border w-full py-2 pl-1 th border-black font-normal text-black text-sm">Debit Maksimal</div>
      <div class="border w-full py-2 pl-1 th border-black font-normal text-black text-sm">Media</div>
      <div class="border w-full py-2 pl-1 th border-black font-normal text-black text-sm">Jumlah Nozzle</div>
    </div>
    <div class="tbody">
      ...
      <div class="tr flex">
        ...
        <div class="border w-full th py-2 pl-1 border-black font-normal text-black text-sm">{{$data->debit_maksimal}}
        </div>
        <div class="border w-full th py-2 pl-1 border-black font-normal text-black text-sm">{{$data->media}}</div>
        <div class="border w-full th py-2 pl-1 border-black font-normal text-black text-sm">{{$data->jumlah_nozzle}}
        </div>
      </div>
      @endforeach
