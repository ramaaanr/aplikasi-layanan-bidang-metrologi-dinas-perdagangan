...
<main class="w-screen h-screen bg-cover bg-center" style="background-image: url('images/hero.jpg')">
  <div class="hero-gradient__container bg-gradient-to-t from-primary h-full  ">
    ...
    <h1 class="mx-auto w-fit font-black text-9xl lg:text-[180px] text-white">500</h1>
    <p class="mx-auto w-fit font-bold text-xl md:text-3xl text-white">Server Bermasalah Silahkan Hubungi Pihak IT</p>
